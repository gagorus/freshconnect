...
<body>
    ...
    <div class="pym-box">
        ...
        <div class="total">
            ...
            <p class = "d-flex"style="margin-top: 10px;margin-bottom: 0px;font-weight: lighter;">Total barang: <span class = "text-right ms-4">Rp {{$price}}</span></p>
            <p class="total2">Delivery: <span class = "text-right ms-4">Rp 0</span></p>
            <p class="total2">Total: <span class = "text-right ms-4">Rp {{$price}}</span></p>
